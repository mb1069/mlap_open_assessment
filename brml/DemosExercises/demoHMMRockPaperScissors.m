...
for currenttime=1:T
    ...
    if currenttime>1
        ...
        for t=1:currenttime
            ...
            pvgh(:,5,t)=zeros(V,1); tmp=o(t-1)+1; if tmp==4; tmp=1; end; pvgh(tmp,5,t)=1; % cycle RPS
            end
        end
        pvgh=condp(pvgh);
    ...
    if showfiltered
        ...
        subplot(2,1,2)
        imagesc(probnextmove); title('next move distribution');  set(gca,'YTickLabel',{'Rock','Paper','Scissors'})
    end
