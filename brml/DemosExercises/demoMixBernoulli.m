...
ph_true = cond(1:H); % hidden distribution
ph_true = cond([0.3 0.7]');
N = 15; % number of training examples
D = 10;  % dimension of each training example
...
loglik=-inf;
for runs=1:3
	[phr pvghr thisloglik phgvr]=MIXprodBern(data,H,opts);
